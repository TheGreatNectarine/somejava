...
public class Timing {
    ...
    private static String form_output(int i, int j, long time) {
        StringBuilder sb = new StringBuilder();
        sb.append(i + " — " + time + " | " + Math.log(i) + " — " + Math.log(time));
        return sb.toString();
    }

    private static void write_to_file(int i, int j) {
        try {
